default_command = "погоди, братан"
no_such_username = "Жаль, но ваша группа не принимает учатие. Хм, а может вы и не студент вообще?"

already_active = "Ваша учетная запись уже активированна)"
activation_success = "Ура, ваша учетная запись активированна"
activation_error = "Упссс, что-то не так, попробуйте позже"
